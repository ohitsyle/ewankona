...
export default function MerchantConfigurationsPage() {
  ...
  const handleManualExport = async () => {
    ...
    try {
      ...
      showAlert('success', `Merchant data exported successfully! (${result.totalRecords} total records)`);
    ...
    <div className="h-full flex flex-col">
      ...
      <div style={{ marginBottom: '24px', borderBottom: '2px solid rgba(255,212,28,0.2)', paddingBottom: '16px' }}>
        <h2 className="text-2xl font-bold text-[#FFD41C] m-0 mb-2 flex items-center gap-[10px]">
          <span>⚙️</span> Merchant Configurations
        </h2>
...
// Shared components (same as Motorpool)
